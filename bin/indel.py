...
def Compare_INDEL(libdic,gold,gold_complex,out_dir):
    #overlap = {}
    overlap = 0
    fn=0
    fp=0
    ...
    ho_he = 0
    if out_dir:
        file_fn = open(out_dir+"/INDEL_fn.txt","w")
        file_fp = open(out_dir+"/INDEL_fp.txt","w")
        file_tp = open(out_dir+"/INDEL_tp.txt","w")
